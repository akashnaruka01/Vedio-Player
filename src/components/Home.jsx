...
const MyCarousel = () => (
  ...
  >
    <Box w="full" h={'100vh'}>
      ...
      <Heading bgColor={['whiteAlpha.100','whiteAlpha.600']} color={'white'} {...headingOptions}>
        Watch The Future
      </Heading>
    </Box>
    <Box w="full" h={'100vh'}>
    ...
    <Box w="full" h={'100vh'}>
      ...
      <Heading  bgColor={['whiteAlpha.100','whiteAlpha.600']} color={'whiteAlpha.600'} {...headingOptions}>
        Gaming on Console
      </Heading>
    </Box>
    ...
    <Box w="full" h={'100vh'}>
      ...
      <Heading bgColor={'blackAlpha.300'} color={'whiteAlpha.900'} {...headingOptions}>
        Night life is cool
      </Heading>
    </Box>
  </Carousel>
