...
const Videos = () => {
  const [videoSrc, setVedioSrc] = useState(videosArr[0]);
  return (
    <Stack direction={['column', 'row']} h={'100vh'}>
      <VStack w={'full'}>
        <video
          ...
          autoPlay
        ></video>
        <VStack alignItems={'flex-start'} p={6} w={'full'}>
          <Heading>Sample Video 1</Heading>
          <Text>
            This is a sample vedio for testing Lorem ipsum, dolor sit amet
            consectetur adipisicing elit. Minima, quia
          </Text>
        </VStack>
      </VStack>
